...
- **Agentfladen (`services/Agent.qml`) — 2026-08-28.** Kun tre tilstande: `ledig`, `arbejder`, `venter`. Den viser sig som **én prik der ånder** i output-pillen — ingen ord. Går der over `body.agentStale` (4 min) uden livstegn, holder prikken op med at ånde og bliver grå: en session der døde uden at sige farvel ser ikke længere ud som en der arbejder.
