...
- Phases, in the order they win (`bar/Body.qml`): **stemme** (dictation, modal) → **aabner** (launcher, has the keyboard) → **aaben** (menu) → **niveau** (vol/light OSD) → **kig** (hover, passive) → **hvile** (battery + clock only).
